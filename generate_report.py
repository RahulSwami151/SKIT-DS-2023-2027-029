...
def get_repo_info():
    """Return the repository name and current branch for the active git repo."""
...
def get_git_metrics(interval="weekly"):
    """Parse git commit logs either for the last 7 days, last 30 days, or all history."""
    ...
    for line in raw_output.strip().split("\n"):
        ...
        if line.startswith("COMMIT|||"):
            ...
            try:
                ...
                if interval == "weekly":
                    period_key = date_obj.strftime("%a (%b %d)")
                elif interval == "monthly":
...
def create_charts(students, timeline_activity, interval):
    """Generate workload and net LOC charts for the PDF report."""
